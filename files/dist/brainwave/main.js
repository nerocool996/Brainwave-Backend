...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.httpGetLatest = function (url) {
        var result = Object(rxjs_ajax__WEBPACK_IMPORTED_MODULE_1__["ajax"])(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (value) {
            value.response = value.response.map(function (val) {
    ...
    HttpService.prototype.httpGetHistory = function (stock) {
        var result = Object(rxjs_ajax__WEBPACK_IMPORTED_MODULE_1__["ajax"])("http://localhost:3000/stocks/" + stock).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (value) {
            value.response = value.response.map(function (val) {
                val.date = new Date(val.date);
                return val;
            });
...
module.exports = __webpack_require__(/*! C:\Users\anandh5\Documents\hackathon\angular\brainwave\src\main.ts */"./src/main.ts");
